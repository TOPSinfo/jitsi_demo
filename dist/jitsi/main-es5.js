(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/
    function srcApp_helperIndexTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcApp_helperJwtInterceptorTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var JwtInterceptor = /*#__PURE__*/function () {
        function JwtInterceptor(authenticationService, route, router) {
        ...
        _createClass(JwtInterceptor, [{
          ...
          value: function intercept(request, next) {
            ...
            var isApiUrl = request.url.startsWith("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl)); // console.log('Is Login :: ', isLoggedIn)
      ...
      var AuthenticationService = /*#__PURE__*/function () {
        ...
        _createClass(AuthenticationService, [{
          ...
          value: function login(email, password) {
            ...
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/users/login"), {
              ...
              if (userInfo) {
                ...
                _this2.currentUserSubject.next(userInfo);
          ...
          value: function getLocalUser() {
            var userInfo;
            var currentUser = localStorage.getItem('currentUser'); // console.log('currentUser :: ', currentUser)
    ...
    function srcApp_servicesIndexTs(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SignalService", function () {
        return _socket_service__WEBPACK_IMPORTED_MODULE_3__["SignalService"];
    ...
    /***/
    function srcApp_servicesSocketServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SignalService = /*#__PURE__*/function () {
        function SignalService() {
          var _this3 = this;

          _classCallCheck(this, SignalService);

          this.env = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"];

          this.listen = function (channel, fn) {
            _this3.socket.on(channel, fn); // this.socket.off(channel, fn);

          };

          this.send = function (chanel, message) {
            _this3.socket.emit(chanel, message);
          };

          this.getSocket = function () {
            return _this3.socket;
          };
        }

        _createClass(SignalService, [{
          key: "connect",
          value: function connect() {
            ...
            this.socket.on('reconnect_attempt', function () {
              _this4.socket.io.opts.transports = ['polling', 'websocket'];
            });
          }
        }, {
          key: "socketId",
      ...
      SignalService.ɵfac = function SignalService_Factory(t) {
        return new (t || SignalService)();
      };

      SignalService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: SignalService,
        factory: SignalService.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SignalService, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
          args: [{
            providedIn: 'root'
          }]
    ...
    function srcApp_servicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var UserService = /*#__PURE__*/function () {
        ...
        _createClass(UserService, [{
          key: "setEditUserDetail",
          value: function setEditUserDetail(user) {
          ...
          value: function create(user) {
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users"), user);
          }
        }, {
          key: "getCallHistory",
          value: function getCallHistory(userId) {
            return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users/calls?adminId=").concat(userId));
          } // getById(id: string) {
          ...
          value: function update(id, params) {
            return this.http.put("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users"), params).pipe(function (x) {
              console.log('---updatew res in service', x); // update stored user if the logged in user updated their own record

              var userValue = JSON.parse(localStorage.getItem('currentUser'));

              if (id == userValue['id']) {
                // update local storage
                var user = Object.assign(Object.assign({}, userValue), params);
          ...
          value: function _delete(user) {
            return this.http["delete"]("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users/").concat(user));
          }
        }, {
          key: "addFeedback",
          value: function addFeedback(feedbackData) {
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users/feedback"), feedbackData);
          }
        }, {
          key: "getRating",
          value: function getRating(adminId) {
            return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users/rating?adminId=").concat(adminId));
          }
        }, {
          key: "saveCallDetails",
          value: function saveCallDetails(callData) {
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl, "/users/calls"), callData);
          }
        }]);
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./components/front-user/dashboard/dashboard.component */
      "./src/app/components/front-user/dashboard/dashboard.component.ts");

      var routes = [// { path: "", pathMatch: "full", redirectTo: 'login' },
      {
        path: "",
        component: _components_front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__["DashboardComponent"],
        pathMatch: "full"
      }, {
        path: "admin",
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function AppComponent_nav_0_div_5_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_nav_0_div_5_Template_a_click_1_listener() {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(authenticationService, route, router, signalService, alertService) {
        ...
        _createClass(AppComponent, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      _context.next = 5;
                      return localStorage.getItem('new_admin');

                    case 5:
                      this.adminId = _context.sent;
          ...
          value: function ngOnInit() {
            ...
            this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (event) {
              ...
              var stateName = currentRoute.snapshot.routeConfig.path;
              _this5.isValidForLogout = stateName !== 'login' && stateName !== '' ? true : false;
              _this5.isValidForNav = stateName !== 'login' && stateName !== '' ? true : false;
            });
          }
        }]);
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbNavbar"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppComponent, [{
          ...
          return [{
            ...
            type: _app_services__WEBPACK_IMPORTED_MODULE_4__["SignalService"]
          }, {
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _app_helper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../app/_helper */
      "./src/app/_helper/index.ts");
      /* harmony import */
      ...
      /*! ngx-toastr */
      "./node_modules/ngx-toastr/__ivy_ngcc__/fesm2015/ngx-toastr.js"); // import { fakeBackendProvider } from '../app/_helper';
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        ...
        providers: [_app_services__WEBPACK_IMPORTED_MODULE_8__["AlertService"], {
          provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"],
          useClass: _app_helper__WEBPACK_IMPORTED_MODULE_9__["JwtInterceptor"],
          multi: true
        }, {
          provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"],
          useClass: _app_helper__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptor"],
          multi: true
        }],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([]), _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_10__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["CommonModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_13__["ToastrModule"].forRoot()]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_10__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["CommonModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_13__["ToastrModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function srcAppComponentsAddUserAddUserComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function AddUserComponent_div_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function AddUserComponent_div_25_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function AddUserComponent_div_25_div_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function AddUserComponent_div_25_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AddUserComponent_div_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
      ...
      function AddUserComponent_option_36_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var AddUserComponent = /*#__PURE__*/function () {
        function AddUserComponent(formBuilder, router, userService, alertService, authenticationService) {
          var _this6 = this;
          ...
          this.createForm = function () {
            _this6.form = _this6.formBuilder.group({
          ...
          this.cancel = function () {
            _this6.title = 'Add User';
            _this6.editData = {};

            _this6.userService.setEditUserDetail({});

            _this6.router.navigate(['/admin/user-list']);
          };
        ...
        _createClass(AddUserComponent, [{
          key: "selected",
          value: function selected() {// console.log('--->>', this.selectedLevel)
          }
        }, {
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.userService.editUserDetail.subscribe(function (data) {
              if (Object.keys(data).length) {
                _this7.editData = data;

                _this7.form.patchValue(Object.assign({}, _this7.editData));

                _this7.title = 'Edit User';
                _this7.selectedLevel = _this7.roleData.filter(function (role) {
                  return role['name'] === data['user_role'];
                })[0];
              }
            });
          ...
          value: function onSubmit() {
            ...
            this.submitted = true;
            this.loading = true; // console.log('---->>', this.form.value);

            this.form.value['role'] = this.selectedLevel.name;

            if (Object.keys(this.editData).length) {
              this.userService.update(this.editData['id'], this.form.value).subscribe(function () {
                _this8.alertService.success('Updated successfully'); // this.router.navigate(['/admin/user-list']);
              ...
              this.userService.create(this.form.value).subscribe(function (data) {
                _this8.alertService.success('Registration successful');

                _this8.router.navigate(['/admin/user-list']);
              }, function (error) {
                _this8.alertService.error(error);
      ...
      AddUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 42,
        vars: 25,
        consts: [[1, "card"], [1, "card-header", "text-center"], [1, "card-body"], [1, "row"], [1, "col-md-4"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["type", "text", "formControlName", "name", 1, "form-control", 3, "ngClass"], [1, "invalid-feedback"], [4, "ngIf"], ["type", "text", "formControlName", "email", 1, "form-control", 3, "ngClass"], ["type", "password", "formControlName", "password", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["type", "text", "formControlName", "username", 1, "form-control", 3, "ngClass"], ["formControlName", "role", "name", "role", 1, "form-control", 3, "ngModel", "ngClass", "ngModelChange", "change"], [3, "ngValue", 4, "ngFor", "ngForOf"], [1, "form-group", "text-center"], [1, "btn", "btn-primary", "btn-width", "blue-btn"], ["type", "button", 1, "btn", "btn-width", "btn-secondary", 3, "click"], [3, "ngValue"]],
        template: function AddUserComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AddUserComponent_Template_form_ngSubmit_7_listener() {
              return ctx.onSubmit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddUserComponent_Template_select_ngModelChange_35_listener($event) {
              return ctx.selectedLevel = $event;
            })("change", function AddUserComponent_Template_select_change_35_listener() {
              return ctx.selected();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddUserComponent_Template_button_click_40_listener() {
              return ctx.cancel();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddUserComponent, [{
          ...
          return [{
            ...
            type: _services_index__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function srcAppComponentsAdminContainerAdminContainerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdminContainerRoutingModule", function () {
        return AdminContainerRoutingModule;
      });
      /* harmony import */
      ...
      var _admin_container_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var routes = [{
        ...
        children: [{
          ...
          path: 'dashboard',
          canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
          component: _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_4__["CallHistoryComponent"]
        }]
      }];

      var AdminContainerRoutingModule = function AdminContainerRoutingModule() {
        _classCallCheck(this, AdminContainerRoutingModule);
      };

      AdminContainerRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: AdminContainerRoutingModule
      });
      AdminContainerRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        factory: function AdminContainerRoutingModule_Factory(t) {
          return new (t || AdminContainerRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AdminContainerRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](AdminContainerRoutingModule, [{
    ...
    /***/
    function srcAppComponentsAdminContainerAdminContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdminContainerComponent", function () {
      ...
      var AdminContainerComponent = /*#__PURE__*/function () {
        function AdminContainerComponent(modalService, signalService) {
          _classCallCheck(this, AdminContainerComponent);
        ...
        _createClass(AdminContainerComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this9 = this;

            this.signalService.listen('send_admin_notification', function (response) {
              if (response.frontUserInfo && response.frontUserInfo.fullname) {
                _this9.modalService.setModalData(Object.assign({}, response), 'notifyAdminModal');

                _this9.modalService.open('notifyAdminModal');

                _this9.acceptObj = response;
              }
            }); // On accept any one user request disconnect to all

            this.signalService.listen('acceptFlag', function (response) {
              _this9.modalService.close('notifyAdminModal');
      ...
      AdminContainerComponent.ɵfac = function AdminContainerComponent_Factory(t) {
        return new (t || AdminContainerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_smart_modal__WEBPACK_IMPORTED_MODULE_1__["NgxSmartModalService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_socket_service__WEBPACK_IMPORTED_MODULE_2__["SignalService"]));
      };

      AdminContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: AdminContainerComponent,
        selectors: [["app-admin-container"]],
        decls: 2,
        vars: 0,
        ...
        directives: [_notification_notification_component__WEBPACK_IMPORTED_MODULE_3__["NotificationComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterOutlet"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminContainerComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            type: ngx_smart_modal__WEBPACK_IMPORTED_MODULE_1__["NgxSmartModalService"]
          }, {
            type: _services_socket_service__WEBPACK_IMPORTED_MODULE_2__["SignalService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function srcAppComponentsAdminContainerAdminContainerModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdminContainerModule", function () {
        return AdminContainerModule;
      });
      /* harmony import */
      ...
      var _admin_container_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./admin-container-routing.module */
      "./src/app/components/admin-container/admin-container-routing.module.ts");
      /* harmony import */


      var _front_user_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../front-user/feedback/feedback.component */
      "./src/app/components/front-user/feedback/feedback.component.ts");

      var AdminContainerModule = function AdminContainerModule() {
        _classCallCheck(this, AdminContainerModule);
      };

      AdminContainerModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
        type: AdminContainerModule
      });
      AdminContainerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        factory: function AdminContainerModule_Factory(t) {
          return new (t || AdminContainerModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], // RouterModule,
        // RouterModule.forRoot([]),
        _admin_container_routing_module__WEBPACK_IMPORTED_MODULE_7__["AdminContainerRoutingModule"], ngx_smart_modal__WEBPACK_IMPORTED_MODULE_4__["NgxSmartModalModule"].forChild()]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AdminContainerModule, {
          declarations: [_notification_notification_component__WEBPACK_IMPORTED_MODULE_0__["NotificationComponent"], _admin_container_component__WEBPACK_IMPORTED_MODULE_1__["AdminContainerComponent"], _front_user_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_8__["FeedbackComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], // RouterModule,
          // RouterModule.forRoot([]),
          _admin_container_routing_module__WEBPACK_IMPORTED_MODULE_7__["AdminContainerRoutingModule"], ngx_smart_modal__WEBPACK_IMPORTED_MODULE_4__["NgxSmartModalModule"]],
          exports: [_notification_notification_component__WEBPACK_IMPORTED_MODULE_0__["NotificationComponent"], _front_user_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_8__["FeedbackComponent"] // RouterModule
          ]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](AdminContainerModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"],
          args: [{
            declarations: [_notification_notification_component__WEBPACK_IMPORTED_MODULE_0__["NotificationComponent"], _admin_container_component__WEBPACK_IMPORTED_MODULE_1__["AdminContainerComponent"], _front_user_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_8__["FeedbackComponent"]],
            exports: [_notification_notification_component__WEBPACK_IMPORTED_MODULE_0__["NotificationComponent"], _front_user_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_8__["FeedbackComponent"] // RouterModule
    ...
    /***/
    function srcAppComponentsCallHistoryCallHistoryComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CallHistoryComponent", function () {
      ...
      function CallHistoryComponent_a_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_tr_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_tr_14_span_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 19);
        }
      }

      function CallHistoryComponent_tr_14_span_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_tr_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
      ...
      function CallHistoryComponent_tr_15_td_1_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var call_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function CallHistoryComponent_tr_15_td_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 22);
      ...
      function CallHistoryComponent_tr_15_td_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_tr_15_td_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td");
      ...
      function CallHistoryComponent_tr_15_td_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_tr_15_td_6_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 22);
      ...
      function CallHistoryComponent_tr_15_td_7_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 22);
      ...
      function CallHistoryComponent_tr_15_td_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 22);
      ...
      function CallHistoryComponent_tr_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
      ...
      function CallHistoryComponent_div_21_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("rateChange", function CallHistoryComponent_div_21_Template_ngb_rating_rateChange_2_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23);

            var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r22.avgRating = $event;
          });
      ...
      function CallHistoryComponent_ng_template_25_span_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_ng_template_25_span_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CallHistoryComponent_ng_template_25_span_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 30);
        ...
        if (rf & 2) {
          var fill_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().fill;
      ...
      function CallHistoryComponent_ng_template_25_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var CallHistoryComponent = /*#__PURE__*/function () {
        function CallHistoryComponent(userService, authenticateService, config, alertservice) {
          _classCallCheck(this, CallHistoryComponent);
          ...
          this.calls = [];
          this.callResp = {};
          this.avgRating = 0; // totalRating: any = 0;
        ...
        _createClass(CallHistoryComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this10 = this;

            this.loading = true; // if (currentUser) {
            ...
            this.userService.getCallHistory(this.userInfo.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (callResp) {
              console.log('Call History :: ', callResp);

              if (!callResp.error) {
                _this10.calls = callResp.data;

                _this10.userService.getRating(_this10.userInfo.userId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (rating) {
                  console.log('Rating :: ', rating);

                  if (rating && rating.data && rating.data.length) {
                    for (var i = 0; i < rating.data.length; i++) {
                      _this10.gotRating += parseInt(rating.data[i].feedback); // this.totalRating += parseInt(rating.data[i].rating);
                    }

                    console.log('Got Rating :: ', _this10.gotRating); // console.log('Tota Rating :: ', this.totalRating);

                    _this10.rating = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].rating;
                    _this10.reviews = rating.data.length;
                    _this10.avgRating = (_this10.gotRating * _this10.rating / (rating.data.length * _this10.rating)).toFixed(1);
                    console.log('Avg Rating :: ', _this10.avgRating);
                  }
      ...
      CallHistoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbRating"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CallHistoryComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
          ...
          return [{
            ...
            type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbRatingConfig"]
          }, {
    ...
    function srcAppComponentsComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ngx_smart_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ngx-smart-modal */
      "./node_modules/ngx-smart-modal/__ivy_ngcc__/esm2015/ngx-smart-modal.js");
      /* harmony import */
      ...
      var _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./call-history/call-history.component */
      "./src/app/components/call-history/call-history.component.ts");
      /* harmony import */


      var _front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./front-user/dashboard/dashboard.component */
      "./src/app/components/front-user/dashboard/dashboard.component.ts");
      /* harmony import */
      ...
      var _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./admin-container/admin-container.module */
      "./src/app/components/admin-container/admin-container.module.ts");
      /* harmony import */


      var _front_user_modal_component_modal_component_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./front-user/modal-component/modal-component.component */
      ...
      /*! @ng-bootstrap/ng-bootstrap */
      "./node_modules/@ng-bootstrap/ng-bootstrap/__ivy_ngcc__/fesm2015/ng-bootstrap.js"); // import { AppRoutingModule } from './app-routing.module';
      ...
      ComponentModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: ComponentModule
      });
      ComponentModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        factory: function ComponentModule_Factory(t) {
          return new (t || ComponentModule)();
        },
        providers: [_app_services__WEBPACK_IMPORTED_MODULE_7__["AlertService"]],
        imports: [[_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_16__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], // AppRoutingModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__["AdminContainerModule"], ngx_smart_modal__WEBPACK_IMPORTED_MODULE_6__["NgxSmartModalModule"].forChild()], // NotificationComponent,
        _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__["AdminContainerModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](ComponentModule, {
          declarations: [// AppComponent,
          _header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _add_user_add_user_component__WEBPACK_IMPORTED_MODULE_9__["AddUserComponent"], _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_10__["CallHistoryComponent"], _front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_12__["LoginComponent"], _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_13__["UserListComponent"], _front_user_modal_component_modal_component_component__WEBPACK_IMPORTED_MODULE_15__["ModalComponentComponent"], SafePipe],
          imports: [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_16__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], // AppRoutingModule,
          _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__["AdminContainerModule"], ngx_smart_modal__WEBPACK_IMPORTED_MODULE_6__["NgxSmartModalModule"]],
          exports: [_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _add_user_add_user_component__WEBPACK_IMPORTED_MODULE_9__["AddUserComponent"], _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_10__["CallHistoryComponent"], _front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_12__["LoginComponent"], _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_13__["UserListComponent"], // NotificationComponent,
          _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__["AdminContainerModule"]]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ComponentModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
          args: [{
            exports: [_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _add_user_add_user_component__WEBPACK_IMPORTED_MODULE_9__["AddUserComponent"], _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_10__["CallHistoryComponent"], _front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_12__["LoginComponent"], _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_13__["UserListComponent"], // NotificationComponent,
            _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__["AdminContainerModule"]],
            declarations: [// AppComponent,
            _header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _add_user_add_user_component__WEBPACK_IMPORTED_MODULE_9__["AddUserComponent"], _call_history_call_history_component__WEBPACK_IMPORTED_MODULE_10__["CallHistoryComponent"], _front_user_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_12__["LoginComponent"], _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_13__["UserListComponent"], _front_user_modal_component_modal_component_component__WEBPACK_IMPORTED_MODULE_15__["ModalComponentComponent"], SafePipe // FeedbackComponent,
            // NotificationComponent
            ],
            imports: [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_16__["NgbModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], // AppRoutingModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _admin_container_admin_container_module__WEBPACK_IMPORTED_MODULE_14__["AdminContainerModule"], ngx_smart_modal__WEBPACK_IMPORTED_MODULE_6__["NgxSmartModalModule"].forChild()],
            providers: [_app_services__WEBPACK_IMPORTED_MODULE_7__["AlertService"]]
          }]
        }], null, null);
      })();
    ...
    /***/
    function srcAppComponentsFrontUserDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _modal_component_modal_component_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../modal-component/modal-component.component */
      "./src/app/components/front-user/modal-component/modal-component.component.ts");
      ...
      var DashboardComponent = /*#__PURE__*/function () {
        function DashboardComponent(formBuilder, signalService, modalService) {
      ...
      DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 14,
        vars: 3,
        consts: [[1, "container-fluid", "mt-4", "mb-4"], [1, "card"], [1, "card-body", "call-window"], [1, "row"], [1, "col-md-12"], [3, "formGroup", "ngSubmit"], [1, "form-group", "text-center"], [1, "title"], [1, "btn", "btn-primary", "btn-width", "blue-btn", 3, "disabled"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "mr-1"]],
        template: function DashboardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function DashboardComponent_Template_form_ngSubmit_5_listener() {
              return ctx.onSubmit();
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashboardComponent, [{
          ...
          return [{
            ...
            type: _services__WEBPACK_IMPORTED_MODULE_2__["SignalService"]
          }, {
    ...
    /***/
    function srcAppComponentsFrontUserFeedbackFeedbackComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FeedbackComponent = /*#__PURE__*/function () {
        function FeedbackComponent(modalService, userService, router, config) {
          var _this11 = this;
          ...
          this.submit = function () {
            console.log('===this.rating', _this11.rating); // this.router.navigate(['/']);

            _this11.modalService.close('feedbackModal');

            var feedbackData = {
              name: _this11.modalData.frontUserName,
              adminId: _this11.modalData.adminUserId,
              // message: this.message,
              feedback: _this11.rating
            };

            _this11.userService.addFeedback(feedbackData).subscribe(function (data) {
              console.log('Feedback Response :: ', data);

              _this11.modalService.open('thankyouModal');
            }, function (error) {
          ...
          this.goToHome = function () {
            _this11.modalService.close('thankyouModal');
          };
        ...
        _createClass(FeedbackComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.modalService.getModal('feedbackModal').onOpen.subscribe(function (modal) {
              console.log('---modal get data-0-----', modal.getData());
              _this12.modalData = modal.getData();
            });
            this.modalService.getModal('feedbackModal').onClose.subscribe(function (modal) {
              _this12.modalService.resetModalData('feedbackModal');
            });
            this.modalService.getModal('thankyouModal').onOpen.subscribe(function (modal) {// console.log('---modal get data-0-----', modal.getData())
      ...
      FeedbackComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function FeedbackComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("rateChange", function FeedbackComponent_Template_ngb_rating_rateChange_7_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FeedbackComponent_Template_button_click_8_listener() {
              return ctx.submit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FeedbackComponent_Template_button_click_20_listener() {
              return ctx.goToHome();
            });
        ...
        directives: [ngx_smart_modal__WEBPACK_IMPORTED_MODULE_2__["NgxSmartModalComponent"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbRating"]],
    ...
    /***/
    function srcAppComponentsFrontUserModalComponentModalComponentComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ModalComponentComponent", function () {
      ...
      function ModalComponentComponent_div_12_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ModalComponentComponent_div_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ModalComponentComponent_div_15_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 30);
      ...
      function ModalComponentComponent_div_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
      ...
      var ModalComponentComponent = /*#__PURE__*/function () {
        function ModalComponentComponent(formBuilder, signalService, modalService, sanitizer, router) {
          var _this13 = this;

          _classCallCheck(this, ModalComponentComponent);
          ...
          this.submit = function () {
            _this13.submitForm = true;
            console.log('getSocket :: ', _this13.signalService.socketId, _this13.signalService.getSocket());
            console.log('-------this.form.error', _this13.userInfoForm);

            if (_this13.userInfoForm.valid) {
              _this13.submitForm = false;

              _this13.modalService.close('userInfoModal');

              _this13.modalService.open('callConnectingModal');

              _this13.connectId = new Date().getTime();
              console.log('FrontId--->>', _this13.connectId);
              var req_connect_data = Object.assign({
                connectId: _this13.connectId
              }, _this13.userInfoForm.value);

              _this13.userInfoForm.reset();

              _this13.signalService.send('req_to_connect', req_connect_data);

              _this13.signalService.listen('front_return_link', function (data) {
                console.log('front_return_link :: ', data);
                _this13.isGetResponse = true;
                _this13.adminUserName = data.adminName;

                if (data.url) {
                  setTimeout(function () {
                    _this13.modalService.close('callConnectingModal');

                    _this13.modalService.open('callConnectedModal');

                    _this13.meetUrl = _this13.sanitizer.bypassSecurityTrustResourceUrl(data.url);
                  }, 3000);
                } else if (data.OnHold) {
                  _this13.isOnHold = true;
                  setTimeout(function () {
                    _this13.modalService.close('callConnectingModal');

                    _this13.modalService.open('callOnHoldModal');

                    setTimeout(function () {
                      _this13.modalService.close('callOnHoldModal');
                    }, 5000);
                  }, 3000);
                } else {
                  _this13.message = data.msg; // if removes this settimeout, the info modal gets open, upon callConnectingModal

                  setTimeout(function () {
                    _this13.modalService.close('callConnectingModal');

                    _this13.modalService.open('infoModal');
                  }, 1000); // this.router.navigate(['/']);
                }
              });

              _this13.signalService.listen('all_admin_reject_request', function (data) {
                _this13.isCallRejected = true;
                console.log('Reject......!!!');

                _this13.modalService.close('callConnectingModal');

                _this13.message = data.msg;

                _this13.modalService.open('infoModal');
              });

              setTimeout(function () {
                if (!_this13.isGetResponse) {
                  console.log('Modal Close automatic...');

                  _this13.modalService.close('callConnectingModal');

                  _this13.modalService.close('infoModal');

                  _this13.message = 'Please Call After some time.';

                  if (!_this13.isCallRejected && !_this13.isOnHold) {
            ...
            _this13.signalService.listen('disconnect_user', function (data) {
              console.log('Data :: ', data);

              _this13.router.navigate(['/']);

              _this13.modalService.closeAll();

              _this13.modalService.setModalData(Object.assign({}, data), 'feedbackModal');

              _this13.modalService.open('feedbackModal');
            });
          };
        ...
        _createClass(ModalComponentComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "creatForm",
      ...
      ModalComponentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function ModalComponentComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ModalComponentComponent_Template_form_ngSubmit_9_listener() {
              return ctx.submit();
            });
    ...
    function srcAppComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HeaderComponent = /*#__PURE__*/function () {
        function HeaderComponent(authenticationService, signalService, router) {
      ...
      HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 10,
        vars: 0,
        consts: [[1, "navbar", "navbar-expand-lg", "navbar-dark", "bg-primary"], ["href", "#", 1, "navbar-brand"], ["type", "button", "data-toggle", "collapse", "data-target", "#navbarNavDropdown", "aria-controls", "navbarNavDropdown", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], [1, "pull-right"], [1, "btn", "btn-link", "pull-right", 2, "background-color", "antiquewhite", 3, "click"], ["id", "navbarNavDropdown", 1, "collapse", "navbar-collapse"], [1, "navbar-nav"]],
        template: function HeaderComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_6_listener() {
              return ctx.logout();
            });
        ...
        directives: [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbNavbar"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](HeaderComponent, [{
          ...
          return [{
            ...
            type: _services_socket_service__WEBPACK_IMPORTED_MODULE_3__["SignalService"]
          }, {
            type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]
          }];
        }, null);
    ...
    function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(formBuilder, route, router, authenticationService, alertService, signalService, toastr) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.loading = true;
            this.authenticationService.login(this.f.email.value, this.f.password.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).subscribe(function (resp) {
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 22,
        vars: 11,
        consts: [[1, "login-otr"], [1, "container"], [1, "text-center"], [1, "login-form"], [3, "formGroup", "ngSubmit"], [1, "form-group", "custom-group"], ["for", "email"], ["src", "assets\\user-icon.png", "alt", "", "width", "20"], ["type", "text", "formControlName", "email", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "password"], ["src", "assets\\lock-icon.png", "alt", "", "width", "23"], ["type", "password", "formControlName", "password", 1, "form-control", 3, "ngClass"], [1, "btn", "btn-primary", "blue-btn", 3, "disabled"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "invalid-feedback"], [4, "ngIf"], [1, "spinner-border", "spinner-border-sm", "mr-1"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoginComponent, [{
          ...
          return [{
            ...
            type: _services__WEBPACK_IMPORTED_MODULE_5__["SignalService"]
          }, {
    ...
    function srcAppComponentsNotificationNotificationComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _assets_libs_external_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../../../assets/libs/external_api.js */
      "./src/assets/libs/external_api.js");
      /* harmony import */


      var _assets_libs_external_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_assets_libs_external_api_js__WEBPACK_IMPORTED_MODULE_1__);
      /* harmony import */
      ...
      function NotificationComponent_div_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationComponent_div_3_Template_button_click_5_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationComponent_div_3_Template_button_click_7_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);
      ...
      var NotificationComponent = /*#__PURE__*/function () {
        function NotificationComponent(signalService, modalService, router, userService, alertService) {
          var _this15 = this;
          ...
          this.accept = function () {
            // this.acceptObj = {};
            _this15.isGetResponse = true;
            console.log('======>> Accept  <<======');
            setTimeout(function () {
              _this15.startTime = new Date().getTime();
              console.log('Start time :: ', _this15.startTime);
            }, 8000); // this.loadJitsi = true;

            _this15.domain = 'meet.jit.si';

            _this15.modalService.open('jitsiMeet');
            ...
            _this15.options = {
              ...
              userInfo: {
                displayName: JSON.parse(localStorage.getItem('currentUser')).username
              } // username: JSON.parse(localStorage.getItem('currentUser')).username,

            };
            _this15.api = new JitsiMeetExternalAPI(_this15.domain, _this15.options);
            console.log('Api :: ', _this15.api._url);

            _this15.api.executeCommand('displayName', _this15.infoObj.frontUserInfo.fullname); // this.api.executeCommand('subject', this.acceptObj.frontUserInfo.subject);
            ...
            _this15.infoObj['link'] = _this15.api._url;
            _this15.infoObj['adminUserId'] = JSON.parse(localStorage.getItem('currentUser')).userId;
            _this15.infoObj['adminUserName'] = JSON.parse(localStorage.getItem('currentUser')).name;

            _this15.signalService.send('accept_connection', _this15.infoObj);

            _this15.api.addEventListener('participantLeft', function (leftUser) {
              console.log('>>>>>>>>>>>>>>>>> User Left------>>', leftUser);

              _this15.disconnectCall();
            }); // participantLeft


            _this15.api.addEventListener('readyToClose', function () {
          ...
          this.reject = function () {
            ...
            _this15.modalService.close('notifyAdminModal'); // this.rejectRespObj = { connectId: this.infoObj.frontId };
            // this.signalService.send('req_to_connect', this.rejectRespObj);


            _this15.signalService.send('reject_call_request', _this15.infoObj);
          };

          this.dataDifference = function (obj) {
          ...
          this.disconnectCall = function () {
            _this15.endTime = new Date().getTime();
            console.log('End Time :: ', _this15.endTime);

            _this15.signalService.send('disconnect_user_admin', _this15.infoObj);

            _this15.modalService.close('jitsiMeet');

            _this15.alertService.error('Call Disconnected..!!');

            document.getElementById('meet').innerHTML = "";

            var duration = _this15.dataDifference({
              date1: _this15.startTime,
              date2: _this15.endTime
            });

            console.log('----->>', duration);
            _this15.callObj = {
              username: _this15.infoObj.frontUserInfo.fullname,
              subject: _this15.infoObj.frontUserInfo.subject,
              adminId: _this15.infoObj.adminUserId,
              duration: duration
            };
            console.log('Call Objec :: ', _this15.callObj);

            _this15.userService.saveCallDetails(_this15.callObj).subscribe(function (data) {
        ...
        _createClass(NotificationComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.modalService.getModal('notifyAdminModal').onOpen.subscribe(function (modal) {
              _this16.acceptObj = modal.getData();
              _this16.infoObj = _this16.acceptObj;
              _this16.frontUserName = _this16.infoObj.frontUserInfo.fullname;
              console.log('Accept Obj ::========================>>>> ', _this16.acceptObj);
              setTimeout(function () {
                if (!_this16.isGetResponse) {
                  _this16.modalService.close('notifyAdminModal'); // alert('User is disconnected....!!!');

                }
              }, 30000);
            });
            this.modalService.getModal('notifyAdminModal').onClose.subscribe(function (modal) {
              _this16.modalService.resetModalData('notifyAdminModal');
      ...
      NotificationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [ngx_smart_modal__WEBPACK_IMPORTED_MODULE_3__["NgxSmartModalComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"]],
    ...
    function srcAppComponentsUserListUserListComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function UserListComponent_div_12_tr_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
      ...
      function UserListComponent_div_12_tr_10_span_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 26);
        }
      }

      function UserListComponent_div_12_tr_10_span_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserListComponent_div_12_tr_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
      ...
      function UserListComponent_div_12_tr_11_td_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserListComponent_div_12_tr_11_td_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 28);
      ...
      function UserListComponent_div_12_tr_11_td_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 28);
      ...
      function UserListComponent_div_12_tr_11_td_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 28);
      ...
      function UserListComponent_div_12_tr_11_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserListComponent_div_12_tr_11_Template_button_click_10_listener() {
            ...
            return ctx_r14.editUser(user_r7);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserListComponent_div_12_tr_11_Template_button_click_14_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);
            ...
            return ctx_r16.deleteUser(user_r7);
          });
      ...
      var UserListComponent = /*#__PURE__*/function () {
        function UserListComponent(userService, authenticationService, modalService, alertService, router) {
          var _this17 = this;
          ...
          this.editUser = function (user) {
            _this17.userService.setEditUserDetail(user);

            _this17.router.navigate(['/admin/edit-user']);
          };

          this.deleteUser = function (user) {
            _this17.deleteUserData = user;

            _this17.modalService.open('confirmModal'); // this.userService.delete(user.id).subscribe(resp => {
          ...
          this.cancel = function () {
            _this17.modalService.close('confirmModal');
          };

          this["delete"] = function () {
            _this17.userService["delete"](_this17.deleteUserData.id).subscribe(function (resp) {
              _this17.modalService.close('confirmModal');

              _this17.alertService.success('User deleted successfully');

              _this17.users = _this17.users.filter(function (data) {
                return data.id !== _this17.deleteUserData.id;
              });
            });
          };
        }
        ...
        _createClass(UserListComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.userService.getAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (resp) {
              _this18.users = resp.data;

              if (_this18.users.length) {
                for (var x = 0; x < _this18.users.length; x++) {
                  _this18.users[x]['avgRating'] = 0;
                  _this18.users[x]['rating'] = 0;
                  var feedback = _this18.users[x].user_feedbacks;

                  if (feedback.length) {
                    for (var i = 0; i < feedback.length; i++) {
                      _this18.users[x]['rating'] += parseInt(feedback[i].feedback);
                    }

                    _this18.users[x]['avgRating'] = (_this18.users[x]['rating'] / feedback.length).toFixed(1);
                  }
                }
              }
      ...
      UserListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function UserListComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserListComponent_Template_button_click_20_listener() {
              return ctx.cancel();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserListComponent_Template_button_click_22_listener() {
              return ctx["delete"]();
            });
        ...
        directives: [_angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], ngx_smart_modal__WEBPACK_IMPORTED_MODULE_4__["NgxSmartModalComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgForOf"]],
    ...
    /***/
    function srcAssetsLibsExternal_apiJs(module, exports, __webpack_require__) {
      !function (e, t) {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/vipul/Projects/jitsi_demo/src/main.ts */
      "./src/main.ts");
      /***/
    },
